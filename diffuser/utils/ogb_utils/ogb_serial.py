...
def get_ogb_maze_ev_probs_fname(env_name):
    ...
    ## Explore
        ...
        hdf5_path = (
            "data/ogb_maze/ev_probs//ogb_antM_LgExpl_ev_prob_numEp20_eSdSt0.hdf5"
        )

    elif env_name == "antmaze-medium-explore-v0":
        hdf5_path = (
            "data/ogb_maze/ev_probs//ogb_antM_MeExpl_ev_prob_numEp20_eSdSt0.hdf5"
        )

    ## ------ Huamnoid ------
    elif env_name == "humanoidmaze-giant-stitch-v0":
        hdf5_path = (
            "data/ogb_maze/ev_probs/ogb_HumM_Gi_ev_prob_numEp20_eSdSt0_full_jnt_fixed.hdf5"
        )
    elif env_name == "humanoidmaze-large-stitch-v0":
        hdf5_path = (
            "data/ogb_maze/ev_probs/ogb_HumM_Lg_ev_prob_numEp20_eSdSt0_full_jnt_fixed.hdf5"
        )

    elif env_name == "humanoidmaze-medium-stitch-v0":
        hdf5_path = (
            "data/ogb_maze/ev_probs/ogb_HumM_Me_ev_prob_numEp20_eSdSt0_full_jnt_fixed.hdf5"
        )
...
def ogb_get_inv_model_path(env_name, gl_dim, inv_hzn=None, logbase="logs"):

    ## -------- All 5 Ant Maze --------
    if env_name == "antmaze-giant-stitch-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/antmaze-giant-stitch-v0/diffusion/og_antM_Gi_o29d_g2d_invdyn_h12"
        elif gl_dim == 15:
            out_path = f"{logbase}/antmaze-giant-stitch-v0/diffusion/og_antM_Gi_o29d_g15d_invdyn_h12"
        elif gl_dim == 29:
            out_path = f"{logbase}/antmaze-giant-stitch-v0/diffusion/og_antM_Gi_o29d_g29d_invdyn_h12_dm5"

    elif env_name == "antmaze-large-stitch-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/antmaze-large-stitch-v0/diffusion/og_antM_Lg_o29d_g2d_invdyn_h12"
        elif gl_dim == 15:
            out_path = f"{logbase}/antmaze-large-stitch-v0/diffusion/og_antM_Lg_o29d_g15d_invdyn_h12"
        elif gl_dim == 29:
            out_path = f"{logbase}/antmaze-large-stitch-v0/diffusion/og_antM_Lg_o29d_g29d_invdyn_h12"

    elif env_name == "antmaze-medium-stitch-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/antmaze-medium-stitch-v0/diffusion/og_antM_Me_o29d_g2d_invdyn_h12"
        elif gl_dim == 15:
            out_path = f"{logbase}/antmaze-medium-stitch-v0/diffusion/og_antM_Me_o29d_g15d_invdyn_h12"
        elif gl_dim == 29:
            out_path = f"{logbase}/antmaze-medium-stitch-v0/diffusion/og_antM_Me_o29d_g29d_invdyn_h12_dm5"

    elif env_name == "antmaze-large-explore-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/antmaze-large-explore-v0/diffusion/og_antMexpl_Lg_o29d_g2d_invdyn_h12"
        elif gl_dim == 15:
            out_path = f"{logbase}/antmaze-large-explore-v0/diffusion/og_antMexpl_Lg_o29d_g15d_invdyn_h12"
        elif gl_dim == 29:
            out_path = f"{logbase}/antmaze-large-explore-v0/diffusion/og_antMexpl_Lg_o29d_g29d_invdyn_h12"

    elif env_name == "antmaze-medium-explore-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/antmaze-medium-explore-v0/diffusion/og_antMexpl_Me_o29d_g2d_invdyn_h12"
        elif gl_dim == 15:
            out_path = f"{logbase}/antmaze-medium-explore-v0/diffusion/og_antMexpl_Me_o29d_g15d_invdyn_h12"
        elif gl_dim == 29:
            out_path = f"{logbase}/antmaze-medium-explore-v0/diffusion/og_antMexpl_Me_o29d_g29d_invdyn_h12"
    ...
    ## ------ All three Huamnoid Maze ------
        ...
        if gl_dim == 2:
            out_path = f"{logbase}/humanoidmaze-giant-stitch-v0/diffusion/og_humM_Gi_o69d_g2d_invdyn_h80_dm5_dout02"

    elif env_name == "humanoidmaze-large-stitch-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/humanoidmaze-large-stitch-v0/diffusion/og_humM_Lg_o69d_g2d_invdyn_h80_dm5_dout02"

    elif env_name == "humanoidmaze-medium-stitch-v0":
        if gl_dim == 2:
            out_path = f"{logbase}/humanoidmaze-medium-stitch-v0/diffusion/og_humM_Me_o69d_g2d_invdyn_h80_dm5_dout02"
    ...
    #### --------- Ant Soccer ---------
        ...
        if gl_dim == 4:
            out_path = f"{logbase}/antsoccer-arena-stitch-v0/diffusion/og_antSoc_Ar_o42d_g4d_invdyn_h120_dout02"
        elif gl_dim == 17:
            out_path = f"{logbase}/antsoccer-arena-stitch-v0/diffusion/og_antSoc_Ar_o42d_g17d_invdyn_h120_dout02"

    elif env_name == "antsoccer-medium-stitch-v0":
        if gl_dim == 4:
            out_path = f"{logbase}/antsoccer-medium-stitch-v0/diffusion/og_antSoc_Me_o42d_g4d_invdyn_h120_dm4_dout02"
        elif gl_dim == 17:
            out_path = f"{logbase}/antsoccer-medium-stitch-v0/diffusion/og_antSoc_Me_o42d_g17d_invdyn_h100_dm4_dout02"
